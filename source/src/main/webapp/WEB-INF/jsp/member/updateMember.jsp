	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" value="<c:out value='${info.ID}'/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="hello" type="text" class="form-control" placeholder="hello" value="<c:out value='${info.HELLO}'/>">
				</div>
			</div>
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<a href="javascript:fn_updateMember()" class="btn btn-primary">회원수정</a>
					<a href="/member/deleteMember.do?id=${info.ID}" class="btn btn-primary">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
...
<script type="text/javascript">
	...
	function fn_updateMember(){
		if (checkForm()!=false){
			...
			document.newMember.action = '/member/updateMember.do';
		}
	}
